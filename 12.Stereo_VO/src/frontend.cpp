...
bool Frontend::InsertKeyframe() {
  ...
  SPDLOG_INFO("Set frame {} as keyframe {}", current_frame_->id_, current_frame_->keyframe_id_);
...
int Frontend::TriangulateNewPoints() {
  ...
  SPDLOG_INFO("new landmarks: {}", cnt_triangulated_pts);
...
int Frontend::EstimateCurrentPose() {
  ...
  SPDLOG_INFO("Outlier/Inlier in pose estimating: {}/{}", cnt_outlier,
              features.size() - cnt_outlier);
  // Set pose and outlier
  current_frame_->SetPose(vertex_pose->estimate());

  SPDLOG_INFO("Current Pose = \n{}", current_frame_->Pose().matrix());
...
int Frontend::TrackLastFrame() {
  ...
  SPDLOG_INFO("Find {} valid features in the last image.", num_good_pts);
  return num_good_pts;
}
...
bool Frontend::BuildInitMap() {
  ...
  SPDLOG_INFO("Initial map created with {} map points", cnt_init_landmarks);

  return true;
}

bool Frontend::Reset() {
  SPDLOG_WARN("Frontend reset is not implemented.");
  return true;
}
